...
\begin{abstract}
    ...
    Thus, it can be a suitable candidate for a new method for quantitative assessment of generated 
    ...
    Results from this work demonstrate that a Vision Transformer is capable of assessing 
